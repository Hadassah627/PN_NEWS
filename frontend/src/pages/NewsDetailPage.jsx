      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <article className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-8 pb-6 border-b border-gray-200">
              ...
              {news.uploadedBy?.reporterId && (
                <div className="flex items-center">
                  ...
                  <span>Reporter: <strong>{news.uploadedBy.reporterId}</strong></span>
                </div>
              )}

              {news.uploadedBy?.name && (
                <div className="flex items-center">
                  <svg className="h-5 w-5 mr-2 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                  </svg>
                  <span>{news.uploadedBy.name}</span>
                </div>
              )}
            ...
            {news.approvalStatus && news.approvalStatus !== 'Approved' && (
              <div className="mt-8 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                <p className="text-sm font-semibold text-yellow-800">
                  Status: {news.approvalStatus}
                </p>
              </div>
            )}
          </div>
