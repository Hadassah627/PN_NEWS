    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <article className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="w-full aspect-video bg-black">
            {embedUrl ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-white">
                <p>Video URL invalid or unavailable</p>
              </div>
            )}
          </div>
          ...
          {/* Content */}
          <div className="p-8">
            {/* Category Badge with Video Label */}
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-8 pb-6 border-b border-gray-200">
              ...
              {video.uploadedBy?.reporterId && (
                <div className="flex items-center">
                  <svg className="h-5 w-5 mr-2 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                  </svg>
                  <span>Reporter: <strong>{video.uploadedBy.reporterId}</strong></span>
                </div>
              )}
            ...
            {video.approvalStatus && video.approvalStatus !== 'Approved' && (
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-xl font-bold mb-4 text-gray-800">Share this video</h3>
